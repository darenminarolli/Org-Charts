...
import { IChartsProps } from './components/IChartsProps';
...
export default class ChartsWebPart extends BaseClientSideWebPart<IChartsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IChartsProps> = React.createElement(
      Charts,
      {
        ...
        site: this.context.pageContext.web.title,
